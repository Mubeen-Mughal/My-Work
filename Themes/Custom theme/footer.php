   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-3">
            ...
            <h3 style="font-size:19px">PURITY DENTAL</h3>
            <p>Serving Families with General,
               Cosmetic,
               and Restorative Care.
            </p>
            <p>89 Police Rd,
               <br><span class="sbrb"></span> VIC 3170
            </p>
            <p>Call <strong><a href="tel:+61395408900">(03) 9540 8900</strong></a>
			
         </div>
         
         <div class="col-sm-3">
       
               <h4 style="font-size:19px">SERVICING SUBURBS</h4>
            <a href="https://puritydental.com.au/clayton-dentist/">Clayton</a> | <a href="https://puritydental.com.au/keysborough-dentist/">Keysborough</a> | <a href="https://puritydental.com.au/wheelers-hill-dentist/">Wheelers Hill</a> | <a href="https://puritydental.com.au/noble-park-dentist/">Noble Park</a> | <a href="https://puritydental.com.au/mount-waverley-dentist/">Mount Waverley</a> | <a href="https://puritydental.com.au/oakleigh-dentist/">Oakleigh</a> | <a href="https://puritydental.com.au/dingley-village-dentist/">Dingley Village</a> | <a href="https://puritydental.com.au/huntingdale-dentist/">Huntingdale</a> | <a href="https://puritydental.com.au/clarinda-dentist/">Clarinda</a> | <a href="https://puritydental.com.au/dandenong-north-dentist/">Dandenong North</a> | <a href="https://puritydental.com.au/springvale-south-dentist/">Springvale South</a> | <a href="https://puritydental.com.au/oakleigh-south-dentist/">Oakleigh South</a> | <a href="https://puritydental.com.au/heatherton-dentist/">Heatherton</a> | <a href="https://puritydental.com.au/noble-park-north-dentist/">Noble Park North</a> | <a href="https://puritydental.com.au/clayton-south-dentist/">Clayton South</a> | <a href="https://puritydental.com.au/oakleigh-east-dentist/">Oakleigh East</a> | <a href="https://puritydental.com.au/scoresby-dentist/">Scoresby</a> | <a href="https://puritydental.com.au/notting-hill-dentist/">Notting&nbsp;Hill</a>
         ...
         <div class="col-sm-3">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d25174.674846907183!2d145.16809200000003!3d-37.9343!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad6151c8a3f6877%3A0x155b0243749c70ca!2sPurity%20Dental%20-%20Dentist%20Mulgrave!5e0!3m2!1sen!2sau!4v1717129565378!5m2!1sen!2sau" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
         </div>
      </div>
   </div>
   <div class="footer-bottom">
<!-- <div class="container">
<p><a href="https://dentalmarketingco.com.au/"> Dental Website Design by Bizgrow Digital</a></p>
</div> -->
</div>
   ...
   <!--<script src="https://unpkg.com/aos@2.3.1/dist/aos.js"></script>-->
	...
	<script>
	  jQuery(function ($) {
       ...
       <?php if(!is_page( array(9317,10603,10913,12371,12958,10870,12916,12933,12871,10926,10929,10919,10933,10936,10922) )):?>
         insertScript('https://puritydental.com.au/wp-content/plugins/contact-form-7/includes/swv/js/index.js');
		 insertScript('https://puritydental.com.au/wp-content/plugins/contact-form-7/includes/js/index.js');
		 insertScript('https://www.google.com/recaptcha/api.js?render=6LcmGLYjAAAAABwYPUWO-rCVN509OA6O4yzMuHyq&ver=3.0');
		 insertScript('https://puritydental.com.au/wp-content/plugins/contact-form-7/modules/recaptcha/index.js');
      <?php endif;?>
		 insertScript('<?php echo get_template_directory_uri(); ?>/plugins/aos/aos.js');
		 insertScript('https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js');
       insertStyles('https://puritydental.com.au/wp-includes/css/dashicons.min.css', 'dashicons');
	...
	<!-- <script src="<?php echo get_template_directory_uri(); ?>/js/casesudy.js"></script> -->
   <script>
   /*
   new BeforeAfter( {
      id: '#one'
      ...
      $(document).ready(function(){
         $(window).scroll(function () {
            ...
            if ($(this).scrollTop() > 10) {
               $('.mobile-buttons-container').addClass('mobile-buttons-container-scroller');
               $('#navbar').addClass('sticky');
            }
            if ($(this).scrollTop() < 10){
                  $('#navbar').removeClass('sticky');
                  $('.mobile-buttons-container').removeClass('mobile-buttons-container-scroller');
            }
         });
      });
   </script>
