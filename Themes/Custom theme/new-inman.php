<?php /* Template Name: new inman page */ ?>
...
<!--start -->
	...
	<section>
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4">
					<?php echo do_shortcode( '[before_after_image id="13061"]');?>
				</div>
				<div class="col-lg-4">
					<?php echo do_shortcode( '[before_after_image id="13062"]' );?>
				</div>
				<div class="col-lg-4">
					<?php echo do_shortcode( '[before_after_image id="13063"]' );?>
				</div>
			</div>
			<!-- <div class="row mt-3">
				<div class="col-lg-4">
